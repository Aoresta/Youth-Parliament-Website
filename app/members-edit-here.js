...
export const rulingMembersEditable = [
  ...
  { name: "Minister 17", role: "Science and Technology Minister", image: "", ideology: "Policy first, popularity second" },
  { name: "Minister 18", role: "Labour Minister", image: "", ideology: "Lead with service, not noise" },
  { name: "Minister 19", role: "Food Minister", image: "", ideology: "Discipline turns debate into action" },
  { name: "Minister 20", role: "Parliamentary Affairs Minister", image: "", ideology: "Speak with facts and listen with respect" }
];
...
export const oppositionMembersEditable = [
  ...
  { name: "Opposition Member 6", role: "Shadow Health Minister", image: "", ideology: "Question with courage, debate with dignity" },
  { name: "Opposition Member 7", role: "Shadow Environment Minister", image: "", ideology: "Hold power accountable" },
  { name: "Opposition Member 8", role: "Shadow Law Minister", image: "", ideology: "Facts make strong questions" },
  { name: "Opposition Member 9", role: "Shadow Transport Minister", image: "", ideology: "Respectful opposition strengthens democracy" },
  { name: "Opposition Member 10", role: "Shadow Agriculture Minister", image: "", ideology: "Listen first, challenge better" },
  { name: "Opposition Member 11", role: "Shadow Digital Affairs Minister", image: "", ideology: "Question with courage, debate with dignity" },
  { name: "Opposition Member 12", role: "Shadow Youth Affairs Minister", image: "", ideology: "Hold power accountable" },
  { name: "Opposition Member 13", role: "Shadow Sports Minister", image: "", ideology: "Facts make strong questions" },
  { name: "Opposition Member 14", role: "Shadow Culture Minister", image: "", ideology: "Respectful opposition strengthens democracy" },
  { name: "Opposition Member 15", role: "Shadow Rural Development Minister", image: "", ideology: "Listen first, challenge better" },
  { name: "Opposition Member 16", role: "Shadow Urban Development Minister", image: "", ideology: "Question with courage, debate with dignity" },
  { name: "Opposition Member 17", role: "Shadow Science Minister", image: "", ideology: "Hold power accountable" },
  { name: "Opposition Member 18", role: "Shadow Labour Minister", image: "", ideology: "Facts make strong questions" },
  { name: "Opposition Member 19", role: "Opposition Whip", image: "", ideology: "Respectful opposition strengthens democracy" },
  { name: "Opposition Member 20", role: "Policy Research Lead", image: "", ideology: "Listen first, challenge better" }
];
...
export const mediaMembersEditable = [
  ...
  { name: "Media Member 5", role: "Social Media Editor", image: "", ideology: "Inform quickly, post carefully" },
  { name: "Media Member 6", role: "Interview Desk", image: "", ideology: "Ask clearly, listen completely" },
  { name: "Media Member 7", role: "Event Report Writer", image: "", ideology: "Write what happened with honesty" }
];
...
export const tableOfficerMembersEditable = [
  ...
  { name: "Table Officer 7", role: "Order Paper Officer", image: "", ideology: "A prepared House is a strong House" }
];
